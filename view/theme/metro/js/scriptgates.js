...
$(document).ready(function () {
    ...
    var colour_array = ['grey','red','blue', 'white'];
    var header_html = '';
    header_html += '<div id="settings"><h2></h2><h3></h3>';
    header_html += '</div>';
	...
	header_html += '<div class="square white" data-theme="white" data-color="219,219,219"></div>';
	header_html += '<label class="text_shadow">Alb</label>';
	header_html += '</div>';
    header_html += '</div>';
